...
export interface IPureSuperTokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "CONSTANT_INFLOW_NFT_LOGIC" | "CONSTANT_OUTFLOW_NFT_LOGIC" | "allowance" | "approve" | "authorizeOperator" | "balanceOf" | "burn" | "constantInflowNFT" | "constantOutflowNFT" | "createAgreement" | "decimals" | "decreaseAllowance" | "defaultOperators" | "downgrade" | "downgradeTo" | "getAccountActiveAgreements" | "getAgreementData" | "getAgreementStateSlot" | "getHost" | "getUnderlyingToken" | "granularity" | "increaseAllowance" | "initialize(address,uint8,string,string)" | "initialize(string,string,uint256)" | "isAccountCritical" | "isAccountCriticalNow" | "isAccountSolvent" | "isAccountSolventNow" | "isOperatorFor" | "makeLiquidationPayoutsV2" | "name" | "operationApprove" | "operationDecreaseAllowance" | "operationDowngrade" | "operationIncreaseAllowance" | "operationSend" | "operationTransferFrom" | "operationUpgrade" | "operatorBurn" | "operatorSend" | "poolAdminNFT" | "poolMemberNFT" | "realtimeBalanceOf" | "realtimeBalanceOfNow" | "revokeOperator" | "selfApproveFor" | "selfBurn" | "selfMint" | "selfTransferFrom" | "send" | "settleBalance" | "symbol" | "terminateAgreement" | "totalSupply" | "transfer" | "transferAll" | "transferFrom" | "updateAgreementData" | "updateAgreementStateSlot" | "upgrade" | "upgradeTo"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "initialize(address,uint8,string,string)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>,
        PromiseOrValue<string>
    ]): string;
    encodeFunctionData(functionFragment: "initialize(string,string,uint256)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>
    ]): string;
...
export interface IPureSuperToken extends BaseContract {
    ...
    functions: {
        ...
        "initialize(address,uint8,string,string)"(underlyingToken: PromiseOrValue<string>, underlyingDecimals: PromiseOrValue<BigNumberish>, n: PromiseOrValue<string>, s: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "initialize(string,string,uint256)"(name: PromiseOrValue<string>, symbol: PromiseOrValue<string>, initialSupply: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "initialize(address,uint8,string,string)"(underlyingToken: PromiseOrValue<string>, underlyingDecimals: PromiseOrValue<BigNumberish>, n: PromiseOrValue<string>, s: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        "initialize(string,string,uint256)"(name: PromiseOrValue<string>, symbol: PromiseOrValue<string>, initialSupply: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        isAccountCritical(account: PromiseOrValue<string>, timestamp: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<boolean>;
        isAccountCriticalNow(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        isAccountSolvent(account: PromiseOrValue<string>, timestamp: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<boolean>;
        isAccountSolventNow(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;

...
export interface SuperTokenMockInterface extends utils.Interface {
    functions: {
        ...
        "SUPERFLUID_NFT_DEPLOYER_LIBRARY_ADDRESS()": FunctionFragment;
        ...
        "constantInflowNFT()": FunctionFragment;
        "constantOutflowNFT()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "CONSTANT_INFLOW_NFT_LOGIC" | "CONSTANT_OUTFLOW_NFT_LOGIC" | "SUPERFLUID_NFT_DEPLOYER_LIBRARY_ADDRESS" | "allowance" | "approve" | "approveInternal" | "authorizeOperator" | "balanceOf" | "burn" | "castrate" | "constantInflowNFT" | "constantOutflowNFT" | "createAgreement" | "decimals" | "decreaseAllowance" | "defaultOperators" | "downgrade" | "downgradeTo" | "getAccountActiveAgreements" | "getAgreementData" | "getAgreementStateSlot" | "getCodeAddress" | "getHost" | "getUnderlyingToken" | "granularity" | "increaseAllowance" | "initialize" | "isAccountCritical" | "isAccountCriticalNow" | "isAccountSolvent" | "isAccountSolventNow" | "isOperatorFor" | "makeLiquidationPayoutsV2" | "mintInternal" | "name" | "operationApprove" | "operationDecreaseAllowance" | "operationDowngrade" | "operationIncreaseAllowance" | "operationSend" | "operationTransferFrom" | "operationUpgrade" | "operatorBurn" | "operatorSend" | "poolAdminNFT" | "poolMemberNFT" | "proxiableUUID" | "realtimeBalanceOf" | "realtimeBalanceOfNow" | "revokeOperator" | "selfApproveFor" | "selfBurn" | "selfMint" | "selfTransferFrom" | "send" | "setNFTProxyContracts" | "settleBalance" | "setupDefaultOperators" | "symbol" | "terminateAgreement" | "totalSupply" | "transfer" | "transferAll" | "transferFrom" | "transferInternal" | "updateAgreementData" | "updateAgreementStateSlot" | "updateCode" | "upgrade" | "upgradeTo" | "waterMark"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "SUPERFLUID_NFT_DEPLOYER_LIBRARY_ADDRESS", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "constantInflowNFT", values?: undefined): string;
    encodeFunctionData(functionFragment: "constantOutflowNFT", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "poolAdminNFT", values?: undefined): string;
    encodeFunctionData(functionFragment: "poolMemberNFT", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setNFTProxyContracts", values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<string>
    ...
    decodeFunctionResult(functionFragment: "SUPERFLUID_NFT_DEPLOYER_LIBRARY_ADDRESS", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "constantInflowNFT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "constantOutflowNFT", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "poolAdminNFT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "poolMemberNFT", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setNFTProxyContracts", data: BytesLike): Result;
...
export interface SuperTokenMock extends BaseContract {
    ...
    functions: {
        ...
        SUPERFLUID_NFT_DEPLOYER_LIBRARY_ADDRESS(overrides?: CallOverrides): Promise<[string]>;
        ...
        constantInflowNFT(overrides?: CallOverrides): Promise<[string]>;
        constantOutflowNFT(overrides?: CallOverrides): Promise<[string]>;
        ...
        setNFTProxyContracts(constantOutflowNFTAddress: PromiseOrValue<string>, constantInflowNFTAddress: PromiseOrValue<string>, poolAdminNFTAddress: PromiseOrValue<string>, poolMemberNFTAddress: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setNFTProxyContracts(constantOutflowNFTAddress: PromiseOrValue<string>, constantInflowNFTAddress: PromiseOrValue<string>, poolAdminNFTAddress: PromiseOrValue<string>, poolMemberNFTAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        SUPERFLUID_NFT_DEPLOYER_LIBRARY_ADDRESS(overrides?: CallOverrides): Promise<BigNumber>;
        allowance(account: PromiseOrValue<string>, spender: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        approve(spender: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        ...
        constantInflowNFT(overrides?: CallOverrides): Promise<BigNumber>;
        constantOutflowNFT(overrides?: CallOverrides): Promise<BigNumber>;
        createAgreement(id: PromiseOrValue<BytesLike>, data: PromiseOrValue<BytesLike>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        ...
        poolAdminNFT(overrides?: CallOverrides): Promise<BigNumber>;
        poolMemberNFT(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        SUPERFLUID_NFT_DEPLOYER_LIBRARY_ADDRESS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        constantInflowNFT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        constantOutflowNFT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        createAgreement(id: PromiseOrValue<BytesLike>, data: PromiseOrValue<BytesLike>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        ...
        poolAdminNFT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        poolMemberNFT(overrides?: CallOverrides): Promise<PopulatedTransaction>;

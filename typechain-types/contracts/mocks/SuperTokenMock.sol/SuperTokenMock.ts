...
export interface SuperTokenMockInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "CONSTANT_INFLOW_NFT_LOGIC",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "CONSTANT_OUTFLOW_NFT_LOGIC",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "SUPERFLUID_NFT_DEPLOYER_LIBRARY_ADDRESS",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "constantInflowNFT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "constantOutflowNFT",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setupDefaultOperators",
    values: [PromiseOrValue<string>[]]
  ): string;
...
export interface SuperTokenMock extends BaseContract {
  ...
  functions: {
    ...
    setNFTProxyContracts(
      constantOutflowNFTAddress: PromiseOrValue<string>,
      constantInflowNFTAddress: PromiseOrValue<string>,
      poolAdminNFTAddress: PromiseOrValue<string>,
      poolMemberNFTAddress: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

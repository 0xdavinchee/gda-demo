...
export interface CallUtilsMockInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "revertArrayAccess",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertAssert",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertBigArray",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "revertCustomVal",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertDivByZero",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertEmpty",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertEnum",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertOverflow",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "revertPop", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "revertString",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertTest",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "revertZeroInitializedFunctionPointer",
    values?: undefined
  ): string;

...
export interface CFALibraryMockInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "authorizeFlowOperatorWithFullControlTest",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(functionFragment: "cfaV1", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "createFlowByOperatorTest",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "revokeFlowOperatorWithFullControlTest",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "updateFlowByOperatorTest",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "updateFlowOperatorPermissionsTest",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,

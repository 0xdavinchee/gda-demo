...
export interface SuperfluidMockInterface extends utils.Interface {
  functions: {
    ...
    "ctxFunc1(uint256,bytes)": FunctionFragment;
    "ctxFunc2(address,address,bytes32,bytes,bytes,bytes)": FunctionFragment;
    ...
    "jailApp(address)": FunctionFragment;
    ...
    "testCtxFuncX(bytes,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "MAX_APP_CALLBACK_LEVEL",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "ctxFunc1",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "ctxFunc2",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BytesLike>,
  ...
  encodeFunctionData(
    functionFragment: "jailApp(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "jailApp(bytes,address,uint256)",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>
  ...
  decodeFunctionResult(functionFragment: "ctxFunc1", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "ctxFunc2", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "ctxUseCredit",
    data: BytesLike
  ): Result;
...
export interface SuperfluidMock extends BaseContract {
  ...
  functions: {
    ...
    testCtxFuncX(
      dataWithPlaceHolderCtx: PromiseOrValue<BytesLike>,
      ctx: PromiseOrValue<BytesLike>,
      overrides?: CallOverrides
    ): Promise<[string] & { returnedData: string }>;

...
export declare namespace SuperTokenFactoryBase {
  export type InitializeDataStruct = {
    underlyingToken: PromiseOrValue<string>;
    superToken: PromiseOrValue<string>;
  };

  export type InitializeDataStructOutput = [string, string] & {
    underlyingToken: string;
    superToken: string;
  };
}

export interface SuperTokenFactoryUpdateLogicContractsTesterInterface
  ...
  encodeFunctionData(
    functionFragment: "_SUPER_TOKEN_LOGIC",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "initializeCanonicalWrapperSuperTokens",
    values: [SuperTokenFactoryBase.InitializeDataStruct[]]
  ): string;
  encodeFunctionData(
...
export interface SuperTokenFactoryUpdateLogicContractsTester
  ...
  functions: {
    ...
    initializeCanonicalWrapperSuperTokens(
      _data: SuperTokenFactoryBase.InitializeDataStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

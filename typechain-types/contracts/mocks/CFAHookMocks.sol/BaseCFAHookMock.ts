...
export interface BaseCFAHookMockInterface extends utils.Interface {
  functions: {
...
export interface BaseCFAHookMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseCFAHookMockInterface;

...
export interface GoodCFAHookMock extends BaseContract {
  ...
  functions: {
    onCreate(
      ...
      newFlowData: IConstantFlowAgreementHook.CFAHookParamsStruct,
    ...
    onDelete(
      token: PromiseOrValue<string>,
      newFlowData: IConstantFlowAgreementHook.CFAHookParamsStruct,
      oldFlowRate: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    "OnCreateEvent(address,address,address,address,int96)"(
      token?: null,
      sender?: null,
      receiver?: null,
      flowOperator?: null,
      flowRate?: null
    ): OnCreateEventEventFilter;
    OnCreateEvent(
      token?: null,
      sender?: null,
      receiver?: null,
    ...
    "OnDeleteEvent(address,address,address,address,int96,int96)"(
      token?: null,
      sender?: null,
      receiver?: null,
      flowOperator?: null,
    ...
    "OnUpdateEvent(address,address,address,address,int96,int96)"(
      token?: null,
      sender?: null,
      receiver?: null,
      flowOperator?: null,

...
export interface ConstantFlowAgreementV1Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "CFA_HOOK_GAS_LIMIT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "DEFAULT_MINIMUM_DEPOSIT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAXIMUM_DEPOSIT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAXIMUM_FLOW_RATE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "constantFlowAgreementHook",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ConstantFlowAgreementV1 extends BaseContract {
  ...
  functions: {
    ...
    getFlowByID(
      token: PromiseOrValue<string>,
      flowId: PromiseOrValue<BytesLike>,
      overrides?: CallOverrides
    ): Promise<
      [BigNumber, BigNumber, BigNumber, BigNumber] & {
        timestamp: BigNumber;

...
export interface ITOGAv1Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "changeExitRate",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getCurrentPIC",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getCurrentPICInfo",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getDefaultExitRateFor",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getMaxExitRateFor",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
...
export interface ITOGAv1 extends BaseContract {
  ...
  functions: {
    changeExitRate(
      ...
      newExitRate: PromiseOrValue<BigNumberish>,
    ...
    getDefaultExitRateFor(
      ...
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { exitRate: BigNumber }>;
  ...
  filters: {
    "ExitRateChanged(address,int96)"(
      token?: PromiseOrValue<string> | null,
      exitRate?: null
    ): ExitRateChangedEventFilter;
    ExitRateChanged(
      token?: PromiseOrValue<string> | null,
      exitRate?: null
    ): ExitRateChangedEventFilter;

    "NewPIC(address,address,uint256,int96)"(
      token?: PromiseOrValue<string> | null,
      pic?: null,
      bond?: null,
      exitRate?: null

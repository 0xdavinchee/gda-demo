...
export interface SuperUpgraderInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getBackendAgents",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "grantBackendAgent",
  ...
  encodeFunctionData(
    functionFragment: "isBackendAgent",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "optinAutoUpgrades",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "optoutAutoUpgrades",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "revokeBackendAgent",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export type OptinAutoUpgradeEventFilter =
  TypedEventFilter<OptinAutoUpgradeEvent>;
...
export type OptoutAutoUpgradeEventFilter =
  TypedEventFilter<OptoutAutoUpgradeEvent>;
...
export interface SuperUpgrader extends BaseContract {
  ...
  functions: {
    ...
    upgrade(
      superTokenAddr: PromiseOrValue<string>,
      account: PromiseOrValue<string>,
  ...
  filters: {
    "OptinAutoUpgrade(address)"(
      account?: PromiseOrValue<string> | null
    ): OptinAutoUpgradeEventFilter;
    OptinAutoUpgrade(
      account?: PromiseOrValue<string> | null
    ): OptinAutoUpgradeEventFilter;

    "OptoutAutoUpgrade(address)"(
      account?: PromiseOrValue<string> | null
    ): OptoutAutoUpgradeEventFilter;
    OptoutAutoUpgrade(
      account?: PromiseOrValue<string> | null
    ): OptoutAutoUpgradeEventFilter;

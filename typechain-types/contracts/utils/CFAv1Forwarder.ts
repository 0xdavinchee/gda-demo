...
export interface CFAv1ForwarderInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getAccountFlowrate",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getBufferAmountByFlowrate",
  ...
  encodeFunctionData(
    functionFragment: "getFlowOperatorPermissions",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<string>
  ...
  encodeFunctionData(
    functionFragment: "setFlowrateFrom",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<string>,

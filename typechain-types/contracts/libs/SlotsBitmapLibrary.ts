...
export interface SlotsBitmapLibrary extends BaseContract {
  ...
  functions: {
    listData(
      ...
      bitmapStateSlotId: PromiseOrValue<BigNumberish>,
      dataStateSlotIDStart: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<
      [number[], string[]] & { slotIds: number[]; dataList: string[] }
    >;
  };
  ...
  listData(
    ...
    dataStateSlotIDStart: PromiseOrValue<BigNumberish>,
    overrides?: CallOverrides
  ): Promise<[number[], string[]] & { slotIds: number[]; dataList: string[] }>;

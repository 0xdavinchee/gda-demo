...
import type {
  ...
  SuperTokenFactoryBaseInterface,
} from "../../../../contracts/superfluid/SuperTokenFactory.sol/SuperTokenFactoryBase";
...
export class SuperTokenFactoryBase__factory {
  static readonly abi = _abi;
  static createInterface(): SuperTokenFactoryBaseInterface {
    return new utils.Interface(_abi) as SuperTokenFactoryBaseInterface;
  }
  static connect(
    address: string,

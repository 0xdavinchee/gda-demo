...
import type {
  FlowNFTBase,
  FlowNFTBaseInterface,
} from "../../../contracts/superfluid/FlowNFTBase";
...
export class FlowNFTBase__factory {
  static readonly abi = _abi;
  static createInterface(): FlowNFTBaseInterface {
    return new utils.Interface(_abi) as FlowNFTBaseInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FlowNFTBase {
    return new Contract(address, _abi, signerOrProvider) as FlowNFTBase;
  }
}

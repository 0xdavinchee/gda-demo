...
import type {
  SuperfluidToken,
  SuperfluidTokenInterface,
} from "../../../contracts/superfluid/SuperfluidToken";
...
export class SuperfluidToken__factory {
  static readonly abi = _abi;
  static createInterface(): SuperfluidTokenInterface {
    return new utils.Interface(_abi) as SuperfluidTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SuperfluidToken {
    return new Contract(address, _abi, signerOrProvider) as SuperfluidToken;
  }
}

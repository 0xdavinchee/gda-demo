...
import type {
  ISETH,
  ISETHInterface,
} from "../../../../../contracts/interfaces/tokens/ISETH.sol/ISETH";
...
export class ISETH__factory {
  ...
  static createInterface(): ISETHInterface {
    return new utils.Interface(_abi) as ISETHInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ISETH {
    return new Contract(address, _abi, signerOrProvider) as ISETH;
  }
}

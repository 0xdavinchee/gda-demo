...
import type {
  IPureSuperToken,
  IPureSuperTokenInterface,
} from "../../../../../contracts/interfaces/tokens/IPureSuperToken.sol/IPureSuperToken";
...
export class IPureSuperToken__factory {
  static readonly abi = _abi;
  static createInterface(): IPureSuperTokenInterface {
    return new utils.Interface(_abi) as IPureSuperTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPureSuperToken {
    return new Contract(address, _abi, signerOrProvider) as IPureSuperToken;
  }
}

// Generated by @wagmi/cli@0.1.14 on 6/13/2023 at 5:59:37 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link gdAv1ABI}__ and `functionName` set to `"estimateDistributionActualAmount"`.
 */
export function useGdAv1EstimateDistributionActualAmount<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link gdAv1ABI}__ and `functionName` set to `"estimateFlowDistributionActualFlowRate"`.
 */
export function useGdAv1EstimateFlowDistributionActualFlowRate<
  TSelectData = ReadContractResult<
    typeof gdAv1ABI,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link gdAv1ABI}__ and `functionName` set to `"isPatricianPeriod"`.
 */
export function useGdAv1IsPatricianPeriod<
  TSelectData = ReadContractResult<typeof gdAv1ABI, 'isPatricianPeriod'>,
>(
  config: Omit<
    UseContractReadConfig<typeof gdAv1ABI, 'isPatricianPeriod', TSelectData>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return useContractRead({
    ...
    ...config,
  } as UseContractReadConfig<typeof gdAv1ABI, 'isPatricianPeriod', TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link gdAv1ABI}__ and `functionName` set to `"isPatricianPeriodNow"`.
 */
export function useGdAv1IsPatricianPeriodNow<
  TSelectData = ReadContractResult<typeof gdAv1ABI, 'isPatricianPeriodNow'>,
>(
  config: Omit<
    UseContractReadConfig<typeof gdAv1ABI, 'isPatricianPeriodNow', TSelectData>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return useContractRead({

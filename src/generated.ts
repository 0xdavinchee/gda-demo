// Generated by @wagmi/cli@0.1.14 on 4/24/2023 at 4:15:27 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const superTokenPoolABI = [
  ...
  { type: 'error', inputs: [], name: 'SUPER_TOKEN_POOL_NOT_GDA' },
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link superTokenPoolABI}__ and `functionName` set to `"superToken"`.
 */
export function useSuperTokenPoolSuperToken<
  TSelectData = ReadContractResult<typeof superTokenPoolABI, 'superToken'>,
>(
  config: Omit<
    UseContractReadConfig<typeof superTokenPoolABI, 'superToken', TSelectData>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return useContractRead({
